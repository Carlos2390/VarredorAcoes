...
def varrePagina(qtd):
    ...
    for j in range(0, qtd):
        for i in range(1, 16):
            ...
            print(f"Nome: {nome} | Preço: R$ {preco} | Var D: {varD}% | Var 12M: {var12M}% | Volume: {volume}")
            sql = f"INSERT INTO acoes (nome, preco, varD, var12M, volume) VALUES ('{nome}', {preco}, {varD}, {var12M}, {volume})"
            cursor.execute(sql)
